...
// region [Database]
// Initiates the database session instance based on the project's configurations. Given array is the search path for
// PostgreSQL (schemas which can be queried). The Database instance can then be retrieved (getInstance()->getDatabase()).
DatabaseSession::initiate(Configuration::getDatabaseConfiguration(), ['public']);
// endregion
...
// Uncomment the setupErrorHandling() line to enable a custom management of error. You will then need to define how
